    ...
    public function FetchMails()
    {
        ...
        if (count($gueltigeTreffer) > 0) {
            ...
            foreach ($gueltigeTreffer as $index => $t) {
                ...
                $html .= '<td style="padding:0; font-family:Roboto,Arial,sans-serif; font-size:6vw; font-weight:bold; color:#000; width:70%; vertical-align:middle;">' . htmlspecialchars($t['art']) . '</td>';
                $html .= '<td style="padding:0; font-family:Roboto,Arial,sans-serif; font-size:6vw; font-weight:bold; color:#000; text-align:right; width:30%; vertical-align:middle;">' . htmlspecialchars($kurzdatum) . '</td>';
                $html .= '</tr>';
            }
            $html .= '</table></div>';
